...
> **Disclaimer:** This project is under active development and is not
> stable or production-ready. Its code, tests, and documentation were
> generated by an LLM (Claude), working from a human's direction and
> review, not hand-written from scratch — see the commit history for
